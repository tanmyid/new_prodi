...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#tambahUkuran"><i class="fa fa-plus"></i> Tambah</button>
                <!-- Modal Tambah Ukuran -->
                            ...
                            <div class="modal-body">
                                <form action="" method="post">
                                    <div class="form-group">
                                        <label>Ukuran</label>
                                        <input type="text" class="form-control" placeholder="Masukkan Ukuran ..." name="kategori">
                                    </div>
                            </div>
